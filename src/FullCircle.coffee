...
class FullCircle
	...
	draw: =>
		...
		@Ledscape.fillRange framenum, (@config.pixelsPerStrip/2)+@offset, (@config.pixelsPerStrip/2), @config.colors[1]...
		@Ledscape.fillRange framenum, 0, @offset, @config.colors[1]...
