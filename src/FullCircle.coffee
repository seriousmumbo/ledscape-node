...
class FullCircle
	...
	draw: =>
		...
		framenum = @frame0 ? 0 : 1
		@Ledscape.fillRangeNoWait framenum, @offset, (@config.pixelsPerStrip/2), color[0]...
		@Ledscape.fillRange framenum, (@config.pixelsPerStrip/2)+offset, (@config.pixelsPerStrip/2), color[1]...
